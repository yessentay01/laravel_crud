<x-app-layout>
    ...
    <div class="my-12 p-6 max-w-7xl mx-auto shadow bg-white rounded-lg">
        <form action="{{ route('articles.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <input value="{{ old('fullname') }}" name="fullname" type="text" id="fullname"
            ...
            <div class="mb-6">
                ...
                <input value="{{ old('rating') }}" name="rating" type="text" id="rating"
                       class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 ">
